      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10 pb-10 border-b border-gray-700">
          <div className="lg:col-span-2">
            <div className="flex items-center mb-6">
              <img src="/logo-with-text.svg" alt="TechDrop Logo" className="h-12" />
            </div>
            <p className="text-gray-300 mb-6">
              TechDrop specializes in creating modern, responsive websites and web applications using cutting-edge technologies. We help businesses establish their digital presence with beautiful, functional, and scalable web solutions.
            </p>
            <p className="text-gray-300 mb-6">
              Baner, Pune<br />
              Maharashtra, India
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} TechDrop. All rights reserved.
          </p>
